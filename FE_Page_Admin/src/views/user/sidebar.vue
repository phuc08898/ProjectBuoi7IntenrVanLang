        ...
        <slot name="content">
          ...
          <ul class="nav-main">
            <li class="nav-main-item">
              <RouterLink class="nav-main-link" to="/statistics">
                <i class="nav-main-link-icon fa fa-chart-bar"></i>
                <span class="nav-main-link-name">Thống kê</span>
              </RouterLink>
            </li>
            <li class="nav-main-item">
              <RouterLink class="nav-main-link" to="/post-management">
                <i class="nav-main-link-icon fa fa-edit"></i>
                <span class="nav-main-link-name">Quản lý bài viết</span>
              </RouterLink>
            </li>
            <li class="nav-main-item">
              <RouterLink class="nav-main-link" to="/category-management">
                <i class="nav-main-link-icon fa fa-tags"></i>
                <span class="nav-main-link-name">Quản lý category</span>
              </RouterLink>
            </li>
            <li class="nav-main-item">
              <RouterLink class="nav-main-link" to="/user-management">
